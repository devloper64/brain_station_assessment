package com.example.brain_station_assessment.data.error
...
const val EMAIL_VALID_ERROR = -104

const val FIRST_NAME_VALID_ERROR = -201
const val LAST_NAME_VALID_ERROR = -202
